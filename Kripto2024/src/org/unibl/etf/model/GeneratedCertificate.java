...
public class GeneratedCertificate {
	    ...
	    public GeneratedCertificate(PrivateKey privateKey, X509Certificate certificate) {
	    ...
	    static GeneratedCertificate createCertificate(String cnName, GeneratedCertificate issuer) throws Exception {
	        ...
	        return new GeneratedCertificate(certKeyPair.getPrivate(), cert);
	    }
